...
ana_input='/mnt/d/OPTO_fMRI_CM/BIDS_data/CM033_BIDS/sub-CM033/anat/cm033_brain.nii'
...
norm_dir='/mnt/d/OPTO_fMRI_CM/BIDS_data/CM033_BIDS/sub-CM033/norm/ants/'
func_orig_dir='/mnt/d/CM032_bids_NEW/sub-CM032/func'

func_dir='/mnt/d/OPTO_fMRI_CM/BIDS_data/CM033_BIDS/sub-CM033/norm/ants/func_orig_copy'
warped_funcs='/mnt/d/OPTO_fMRI_CM/BIDS_data/CM033_BIDS/sub-CM033/norm/ants/func_warped'

mkdir -p $norm_dir
mkdir -p $func_dir
mkdir -p $warped_funcs

# cp -r $func_orig_dir/r* ./func_copy
...
func_mean='/mnt/d/OPTO_fMRI_CM/BIDS_data/CM033_BIDS/sub-CM033/func/meansub-CM033_task-MSTIM_run-02_EPI.nii'
