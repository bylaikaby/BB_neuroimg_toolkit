...
ana_input='/mnt/d/OPTO_fMRI_CM/Raw_data/mdeft.nii.gz'

# Define template paths for CMT and NMT
template_CMT='/mnt/d/OPTO_fMRI_CM/Templates/CMT/NMT_warped/NMT2CMT_Warped.nii'
template_NMT='/mnt/d/OPTO_fMRI_CM/Templates/NMT_v2.0_sym/NMT_v2.0_sym/NMT_v2.0_sym.nii.gz'

# Define directories for normalization and output
# D:\OPTO_fMRI_CM\BIDS_data\CM032_BIDS
 #change to OPTO_fMRI_CM directory
...
# inverse_seg_dir='/mnt/d/RawData/BIDS_data/CM032_BIDS/sub-cm032/norm/inverse_seg/'
