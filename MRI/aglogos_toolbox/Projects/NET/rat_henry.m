...
%RAT_HENRY - Returns the ROIs of the rat - 2013-April-24; 2018-Dec-22
%
%
%  EXAMPLE :
%    groi = macaque_henry;
...
% HENRY/YM 2018-12-22: added/updated
% 'ParabrachialN'
% 'LGN'
% 'MGN'
% 'VP'
...
GROI{end+1} =  {'ParabrachialN', 'PBn', [0.31 0.22 0.78], {'ParabrachialN'}};
...
GROI{end+1} =  {'HTh', 'Hypothalamus', [0 .5 0]...
                {'HTv','HTd','AHA','AHC','AHP','ArcD','ArcL','ArcLP','ArcM',...
                 ...
                 'VMHDM','VMHVL','VTM'}};
GROI{end+1} =  {'Preoptic', 'Preoptic Area', [0 .5 0], {'Preoptic'}};
...
GROI{end+1} =  {'LGN', 'Lateral Geniculate n',                [1 .8 .5],...
                {'LGN' }};
...
GROI{end+1} =  {'GP',  'Globus Pallidus', [.5 .8 1],... %separated from striatum
                {'LGP','MGP'}}; %added MGP
GROI{end+1} =  {'VP',  ' Ventral Pallidum', [.5 .8 1],... %separated from GP
                {'VP'}}; % subdivided GP
