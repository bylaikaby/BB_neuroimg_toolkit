function [ANAP, ROI, GRPP] = bggetpars(SesName, ARGS)
%BGGETPARS - Defines Common Parameters for the Basal Ganglia NET-fMRI Project
% [ANAP, ROI, GRPP] = bggetpars(SesName) is called from within each description file to set
...
% get basic/common parameters.  DO NOT EDIT "rpgetpars.m".
[ANAP, ROI, GRPP, FLICK, ESTIM, POLAR] = rpgetpars(SesName, ARGS);
% ok here modify parameters for BasalGanglia project.
