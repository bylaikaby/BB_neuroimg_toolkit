function [grproi, roinames, roicolor, roidescription] = paxroigroups_human(StructName, GrpType)
%PAXROIGROUPS_HUMAN - Returns the group to which StructName belongs
