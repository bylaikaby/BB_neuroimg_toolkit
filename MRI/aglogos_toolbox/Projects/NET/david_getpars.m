function [ANAP, ROI, GRPP, FLICK, ESTIM, POLAR] = david_getpars(SesName, ARGS)
...
if strcmpi(DIRS.HOSTNAME,'nb-nikos') | strcmpi(DIRS.HOSTNAME,'ultrabook-nikos'),
  ANAP.ClusterMode = 0;
end;
...
% elseif exist('y:/','dir'),
%   DRV = 'Y:/';
% elseif strcmpi(DIRS.HOSTNAME,'ultrabook-nikos'),
%   DRV = 'F:/';
% else
%   DRV = 'L:/';
% end;
...
ANAP.project.datadir        = fullfile(DRV,'');
