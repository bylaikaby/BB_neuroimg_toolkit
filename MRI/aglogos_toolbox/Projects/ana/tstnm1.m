%TSTNM1 - test with saline-bath
%         4x4 array with 1.5mm spacing, neurophys room
%
% EXPDATE : 20.06.06 Tue.
% GROUPS :  sound
% EXPERIMENTS : 110
%
% STIMULUS : sound
...
%
% !!!!!!!!!!!!!!!!!!!!!!!
% I used the same electrodes as D04nm1(16.06.06) experiment, no replacement.
% !!!!!!!!!!!!!!!!!!!!!!!
%
% 20.06.06  YM
...
SYSP.dirname	= 'TST.nm1';
SYSP.date		= '20.Jun.06.Tue.';
...
GRP.sound.exps		= [1:100];
GRP.sound.expinfo	= {'recording'};
GRP.sound.stminfo	= 'white noise (flat)';


% 4min blank
GRP.spont.exps		= [100:110];
GRP.spont.expinfo	= {'recording'};
GRP.spont.stminfo	= 'no stimulus';
...
%=======================================================================
for N = 1:110,
  EXPP(N).physfile		= sprintf('tstnm1_%03d.adfw',N);
end
