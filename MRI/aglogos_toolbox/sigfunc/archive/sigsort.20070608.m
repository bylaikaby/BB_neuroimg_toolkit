function varargout = sigsort(iSig,sortPar,PreT,PostT,CHECK_JAWPO,CHECK_CENTROID)
...
if iscell(iSig),
  for N = 1:length(iSig),
    oSig{N} = subDoSort(iSig{N},sortPar,PreT,PostT,CHECK_JAWPO,CHECK_CENTROID);
  end
else
  oSig = subDoSort(iSig,sortPar,PreT,PostT,CHECK_JAWPO,CHECK_CENTROID);
end
...
function oSig = subDoSort(iSig,sortPar,PreT,PostT,CHECK_JAWPO,CHECK_CENTROID)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
