...
switch SigName,
 ...
 case {'plroiTs' 'gmroiTs' 'nmroiTs' 'droiTs' 'throiTs' 'htroiTs' 'sgroiTs' ...
       ...
       'lgnfroiTs','lgnroiTs','pofroiTs','poroiTs','pblfroiTs','pblroiTs'}
 ...
 case { 'blp' 'tblp' 'esblp' 'tnClnblp' 'tfClnblp' 'tmClnblp' 'tmFid',...
  ...
  % ATTENTION: The signal is the average of all experiments
  % For BLPs with 10 bands (if the #exp==10) the TimeXChanXBands can be confusing!!
