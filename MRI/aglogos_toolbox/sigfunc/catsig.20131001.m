...
switch SigName,
 ...
 case {'troiTs' 'tfroiTs' 'iroiTs' 'proiTs' 'ehroiTs', 'emroiTs'},
  ...
  return
 case {'rproiTs' 'gmroiTs' 'nmroiTs' 'droiTs' 'throiTs' 'htroiTs' 'sgroiTs' ...
       'rpfroiTs' 'rphroiTs' 'rpmroiTs' 'thfroiTs' 'thfroiTs' 'cxfroiTs' ...
       'cxroiTs' 'mrroiTs' 'mrfroiTs' 'atfroiTs' 'atroiTs'}
  oSig = catsig_rproiTs(Ses,GrpName,SigName,RoiNames);
  return
 ...
 case {'rpClnTF'}
  oSig = catsig_rpClnTF(Ses,GrpName,SigName);
  return
...
for iExp = 1:length(EXPS),
  ...
  switch SigName,
   ...
   case { 'rpblp', 'nmblp', 'sgblp', 'thblp', 'htblp', 'cxblp'},
