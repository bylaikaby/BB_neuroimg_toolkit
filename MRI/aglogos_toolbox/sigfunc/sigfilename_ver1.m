function filename = sigfilename_ver1(Ses,ExpNo,ftype)
...
%   YM,  31.01.12 renamed as sigfilename_ver1.
%
...
switch lower(ftype),
 ...
 case lower(Ses.ctg.GrpDEPSigs)
  filename = catfilename(Ses,ExpNo,'contrasts');
  
 otherwise
  disp('sigfilename_ver1: Wrong file type [phys,evt,img]');
  keyboard;
end
