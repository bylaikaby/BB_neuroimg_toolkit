function oSig = grp_spktrigsig(Ses,GRPEXPS,SigName)
%GRP_SPKTRIGSIG - groups spike-triggered signals
%  SIG = GRP_SPKTRIGSIG(SESSION,GRP/EXPS)
%  SIG = GRP_SPKTRIGSIG(SESSION,GRP/EXPS,SIGNAME)
%
%  VERSION :
...
if nargin < 2, help grp_spktrigsig; return;  end

if nargin < 3, SigName = 'Spktblp';  end
oSig = {};
