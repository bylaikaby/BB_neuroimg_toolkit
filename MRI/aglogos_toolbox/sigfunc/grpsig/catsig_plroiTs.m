function oSig = catsig_plroiTs(Ses,GrpExp,SigName,RoiNames,varargin)
%CATSIG_RPROITS - subfunction for catsig(plroiTs).
%  oSig = CATSIG_RPROITS(Ses,GrpExp,SigName,RoiNames,...) 
%
%  SigName : 'plroiTs' 'gmroiTs' 'swroiTs' 'droiTs' 'throiTs' 'plfroiTs'
%
%  VERSION :
