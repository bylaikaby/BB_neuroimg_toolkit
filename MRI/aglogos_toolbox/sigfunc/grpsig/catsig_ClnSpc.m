function oSig = catsig_ClnSpc(Ses,GrpExp,SigName,varargin)
%CATSIG_CLNSPC - subfunction for catsig(ClnSpc).
%  oSig = CATSIG_CLNSPC(Ses,GrpExp,SigName,...) 
%
%  SigName : 'ClnSpc' 'rpClnSpc'
%
%  VERSION :
