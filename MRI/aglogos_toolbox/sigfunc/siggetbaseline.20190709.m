function stat = siggetbaseline(Sig, datname, epoch, ModelNo, HemoDelay, HemoTail)
%SIGGETBASELINE - get baseline activity of signal "Sig"
%	stat = SIGGETBASELINE(Sig) returns the mean, sd and epoch
...
%
%	STAT = SIGGETBASELINE(SIG, DATNAME);
%	STAT = SIGGETBASELINE(SIG, DATNAME, EPOCH);
%	STAT = SIGGETBASELINE(SIG, DATNAME, EPOCH, ModelNo);
%   STAT = SIGGETBASELINE(SIG, DATNAME, EPOCH, ModelNo, HEMODELAY, HEMOTAIL);
%
...
%   YM,  09.07.19  renamed as siggetbaseline() from getbaseline().
%
