...
%   ANAP.siggetblp.band{ 7}     = {[   0   conv2sdu     = 0;            % 1:tosdu,2:detrend,3:zerobase, can be char 90] 'LFP'     'LFP', 0};
...
%   YM  20.12.05  supports mirroring signal aconv2sdu     = 0;            % 1:tosdu,2:detrend,3:zerobase, can be chart both time edges to avoid unstable filtering.
...
%   YM  15.05.09  add missing 40-60Hz band as lgamma.
%   YM  15.02.13  supports despiking.
%
% See also SESGETBLP EXPSIGGETBLP BLPFREQZ RESAMPLE FILTFILT HILBERT clndespike
...
info.mBands    = [8];              % Bands in the MUA range
...
fprintf('DECIM[%gHz].',1/lSig.dx/DECI);
