function testmualfpcor(SESSION, ExpNo, TWINDOW_SEC)
...
INFO = blp.info;
matfile = sprintf('%s_%s_%03d_%07d.mat',mfilename,blp.session,blp.ExpNo,TWINDOW_SEC*1000);
save(matfile,'INFO','CORMUA','CORMUA2','TWINDOW_SEC','TSHIFT_SEC');
