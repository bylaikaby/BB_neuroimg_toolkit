function varargout = clnadfview(varargin)
%CLNVIEW - displays adf/cln spectrum
%  CLNADFVIEW(SESSION,GRPNAME) displays adf/cln spectrum.
%
%
%  VERSION :
%    0.90 29.09.11 YM  pre-release
%    0.91 07.07.20 YM  use sigfilename()/expfilename().
%    0.92 07.07.20 YM  renamed as clnadfview from clnview.
%
...
if nargin > 1 && isnumeric(varargin{2}),
  ...
  ANAP.adffile = expfilename(Ses,ExpNo,'adfw');
  ANAP.clnfile = sigfilename(Ses,ExpNo,'cln');
