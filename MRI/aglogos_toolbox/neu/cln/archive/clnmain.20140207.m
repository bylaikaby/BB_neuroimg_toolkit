...
if isfield(tmpanap,'clnpar'),  ANAP = sctmerge(ANAP,tmpanap.clnpar);  end
clear tmpanap;
...
fprintf('          NPCs=%d NRem=%d PCACoef=%.2f PrePCA=%.1fms UseLANSVD=%d\n',...
        ANAP.NOPCS,ANAP.NOREM,ANAP.PCACOEF,ANAP.PREPCA*1000,ANAP.USE_LANSVD);
