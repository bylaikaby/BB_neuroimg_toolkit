...
%
%  VERSION :
%	1.00 YM  24.05.05  derived from clnmain.m of NKL.
%	1.01 YM  03.08.05  bug fix.
%	1.02 YM  15.08.05  checks Ses.anap.clnpar as cleaning params.  
%	1.03 YM  05.03.08  supports REMOVE_ES.
%	1.04 YM  07.06.10  uses grp.hardch for phys channels.
%	1.05 YM  07.10.10  supports grp.procch to control the cleaning procedure.
%	1.06 YM  07.10.10  bug fix of OUTLIERS, now done by channel.
%	1.07 YM  15.02.11  supports GRPP.(xxx).stimch.
%	1.08 YM  31.01.12  uses sigfilename().
%	1.10 YM  12.04.13  channel order follows grp.hardch, no sorting.
%	1.11 YM  17.07.13  use sigsave().
%	1.12 YM  30.08.13  supports "LOWRECOVER".
%	1.13 YM  02.09.13  supports "REMOVE_ECG".
%
...
% PRINT INFO
% =================================================================
fprintf(' %s: %s Exp=%d  NObs=%d NChn=%d ',...
        mfilename,Ses.name,ExpNo,MriEvt.NoObsp,length(VALID_CHAN));
fprintf(' Dec=%d NPCs=%d NRem=%d PCACoef=%.2f PrePCA=%.1fms SaveGra=%d RemoveES=%d RemoveECG=%d\n',...
        ANAP.DECFRAC,ANAP.NOPCS,ANAP.NOREM,ANAP.PCACOEF,ANAP.PREPCA*1000,...
        ANAP.SAVEGRA,ANAP.REMOVE_ES,ANAP.REMOVE_ECG);
