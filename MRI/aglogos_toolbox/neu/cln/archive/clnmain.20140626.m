...
fprintf(' Upsample=%d Dec=%d SaveGra=%d RemoveES/ECG=%d/%d  DEBUG/PLOT=%d/%d\n',...
        ANAP.UPSAMPLE,ANAP.DECFRAC,ANAP.SAVEGRA,ANAP.REMOVE_ES,ANAP.REMOVE_ECG,ANAP.DEBUG,ANAP.PLOT);
