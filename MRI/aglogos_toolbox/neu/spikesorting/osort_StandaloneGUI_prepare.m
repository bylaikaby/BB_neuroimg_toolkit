function [normalizationChannels,paramsIn] = osort_StandaloneGUI_prepare(noiseChannels,doGroundNormalization,paramsIn,filesToProcess, filesAlignMax, filesAlignMin )
