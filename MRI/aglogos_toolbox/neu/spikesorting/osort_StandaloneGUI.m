...
%
%urut/may07
function osort_StandaloneGUI(paths, filesToProcess, thres, normalizationChannels, paramsIn)
starttime=clock;
...
for kkk=1:length(filesToProcess)
    ...
    if paramsIn.doDetection
        ...
        handles = osort_StandaloneInit( handles , paramsIn.tillBlocks, paramsIn.prewhiten, paramsIn.alignMethod(kkk),includeRange );
