function y = wvc_fix_filter(x)
% wvc_fix_filter (in case signal processing toolbox is not available).
% filters data x with an eliptic passband between [300 3000] Hz.
%
%
%  VERSION :
%    1.00 24.03.14 YM  modified from wave_clus's fix_filter().
%
%  See also wvc_amp_detect
