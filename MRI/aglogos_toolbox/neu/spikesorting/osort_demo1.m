...
paths.basePath='D:/Temp/osort_data/';
...
paths.pathOut= fullfile(paths.basePath, 'sort/');
paths.pathRaw= fullfile(paths.basePath, '/raw/');
paths.pathFigs= fullfile(paths.basePath, '/figs/');
...
%% execute
[normalizationChannels,paramsIn] = osort_StandaloneGUI_prepare(noiseChannels,doGroundNormalization,paramsIn,filesToProcess,filesAlignMax, filesAlignMin);
osort_StandaloneGUI(paths, filesToProcess, thres, normalizationChannels, paramsIn);
