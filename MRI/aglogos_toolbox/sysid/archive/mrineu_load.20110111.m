...
%    EleName    : channel selection for blp
...
if isrecording(grp),
  ...
  [blp spk] = sub_neuload(Ses,GrpExp,EleName,NeuSig,AddSpike);
else
  AddSpike = 0;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [blp spk] = sub_neuload(Ses,GrpExp,EleName,SigName,AddSpike)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
blp = [];
spk = [];
