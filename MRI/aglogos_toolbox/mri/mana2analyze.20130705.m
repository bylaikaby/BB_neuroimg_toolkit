...
%
%  See also hdr_init anz_write mstat2analyze
...
anzfile = fullfile(DIR_NAME,SAVE_FILE);
fp = fileparts(anzfile);
if ~isempty(fp)
...
subWriteInfo(anzfile,hdr,V_PERMUTE,V_FLIPDIM);
fprintf(' done.\n');
...
% ==================================================================================
function subWriteInfo(ANZFILE,HDR,V_PERMUTE,V_FLIPDIM)
% ==================================================================================
