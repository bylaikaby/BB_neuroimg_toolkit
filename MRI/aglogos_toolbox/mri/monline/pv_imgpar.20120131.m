...
%
%  EXAMPLE :
%    imgp = pv_imgpar('\\wks8\guest\H05.Tm1\55\pdata\1\2dseq');  % RARE
%    imgp = pv_imgpar('\\wks8\guest\B07.371\62\pdata\1\2dseq');  % FLASH
%    imgp = pv_imgpar('\\wks8\guest\J02.Hx1\7\pdata\1\2dseq');   % MDEFT
%    imgp = pv_imgpar('\\wks8\guest\B07.371\46\pdata\1\2dseq');  % EPI
...
fprintf('%s TEST MODE\n',mfilename);
% RARE
IMG{1} = {'RARE';     '\\wks8\guest\H05.Tm1\55\pdata\1\2dseq' };
IMG{2} = {'FLASH';    '\\wks8\guest\B07.371\62\pdata\1\2dseq' };
IMG{3} = {'MDEFT';    '\\wks8\guest\J02.Hx1\7\pdata\1\2dseq'  };
IMG{4} = {'EPI';      '\\wks8\guest\B07.371\46\pdata\1\2dseq' };
