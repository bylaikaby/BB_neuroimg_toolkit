...
%    1.04 12.06.26 YM  adapted for ICPBR scanners.
%
...
%DEF.study     = 'D04.LG1';
%DEF.fscan     = '14';
switch lower(char(java.net.InetAddress.getLocalHost().getHostName()))
  case {'l01w206' 'l01w207'}  % NHP 70/40 horizontal
    DEF.datadir = '//10.102.5.112/share';
  case {'l01w103' 'l01w104'}  % NNHP 47/60 vertical
    DEF.datadir = '//10.102.5.48/share';
end
