...
%    1.33 01.04.20 YM   obsolete imresize_old().
%    1.40 23.04.20 YM   changed the Y direction and coordinates as EPI to fix PickArea bug in EPI-ana.
%    1.41 24.04.20 YM   clean-up.
%
...
BkgColor = get(hMain,'Color');

% WIDGETS TO SELECT ROI %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
XDSP = 7; H = figH - 2.5;
uicontrol(...
    'Style','Text','Tag','RoiTxt','String','ROI:',...
    'Parent',hMain,'Units','char','Position',[XDSP H-0.3 30 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
roinames = cell(1,length(ROITS));
...
uicontrol(...
    'Style','Popupmenu','Tag','RoiCmb',...
    'String',roinames,'Value',idx(1),'TooltipString','Select ROI(s) to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+8.5 H 22 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''select-stat'',guidata(gcbo))',...
    'HorizontalAlignment','left','FontWeight','Bold');
clear roinames idx;
% Pick Area Combo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Popupmenu','Tag','PickAreaCmb',...
    'String',{'--- PickArea ---','Append','Replace','Delete','Coordinate'},'Value',1,...
    'TooltipString','Select PickArea action',...
    'Parent',hMain,'Units','char','Position',[XDSP+32 H 22 1.5],...
...
uicontrol(...
    'Style','Checkbox','Tag','DrawRoiCheck',...
    'String','DrawROI','Value',ANAP.mview.drawroi,...
    'TooltipString','draw ROIs',...
    'Parent',hMain,'Units','char','Position',[XDSP+56 H 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''toggle-drawrois'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
% CHECK BOX FOR "draw-ele" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Checkbox','Tag','DrawEleCheck',...
    'String','ELE','Value',ANAP.mview.drawele,...
    'TooltipString','draw ELEs',...
    'Parent',hMain,'Units','char','Position',[XDSP+71 H 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''toggle-draweles'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);

% Multiple testing corretion %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Text','Tag','TestingCorrTxt','String','p-values adjust:',...
    'Parent',hMain,'Units','char','Position',[XDSP+88 H-0.3 30 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Popupmenu','Tag','TestingCorrCmb',...
    'String',{'none','Bonferroni','Holm','Hochberg','BY','BH(fdr)','Sidak'},...
    'Value',1,...
    'TooltipString','Multiple testing correction',...
    'Parent',hMain,'Units','char','Position',[XDSP+107 H 20.2 1.5],...
...
uicontrol(...
    'Style','Checkbox','Tag','MaskBlackCheck','String','Black-mask','Value',0,...
    'TooltipString','Mask black regrions',...
    'Parent',hMain,'Units','char','Position',[XDSP+130 H 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''edit-alpha'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);

% Masking by tSNR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
MaskBySnrCheck = uicontrol(...
    'Style','Checkbox','Tag','MaskBySnrCheck','String','tSNR-mask','Value',0,...
    'TooltipString','mask by tSNR',...
    'Parent',hMain,'Units','char','Position',[XDSP+147 H 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''edit-alpha'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
MaskBySnrEdt = uicontrol(...
    'Style','Edit','Tag','MaskBySnrEdt','String','40',...
    'TooltipString','tSNR for masking',...
    'Parent',hMain,'Units','char','Position',[XDSP+164 H 8 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''edit-alpha'',guidata(gcbo))',...
    'HorizontalAlignment','left','FontWeight','Bold');
...
XDSP = 7; H = figH - 4.5;
uicontrol(...
    'Style','Text','Tag','PvalueTxt','String','STAT:',...
    'Parent',hMain,'Units','char','Position',[XDSP H-0.3 30 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','AlphaEdt','String',num2str(ANAP.mview.alpha),...
...
uicontrol(...
    'Style','Popupmenu','Tag','StatCmb','String',stats,'Value',idx,...
    'TooltipString','Select stat. analysis to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+32 H 22 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''init-stat'',guidata(gcbo))',...
    'HorizontalAlignment','left','FontWeight','Bold');
uicontrol(...
    'Style','Popupmenu','Tag','ModelCmb','String',{'1'},'Value',1,...
    'TooltipString','Select Model to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+56 H 31 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''select-stat'',guidata(gcbo))',...
    'HorizontalAlignment','left','FontWeight','Bold');
trials = {};
if iscell(ROITS{1})
...
uicontrol(...
    'Style','Popupmenu','Tag','TrialCmb','String',trials,'Value',tmptrial,...
    'TooltipString','Select Trial to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+89.2 H 31 1.5],...
...
uicontrol(...
    'Style','Checkbox','Tag','ClusterCheck',...
    'String','Cluster','Value',ANAP.mview.cluster,...
    'TooltipString','Cluster detection',...
    'Parent',hMain,'Units','char','Position',[XDSP+130 H 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''edit-alpha'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Popupmenu','Tag','ClusterCmb',...
    'String',clusterfuncs,'Value',idx,...
    'TooltipString','Select a function for clustering',...
    'Parent',hMain,'Units','char','Position',[XDSP+147 H 25 1.5],...
...
XDSP = 7; H = figH - 6.5;
uicontrol(...
    'Style','Text','Tag','PvalueTxt','String','View:',...
    'Parent',hMain,'Units','char','Position',[XDSP H-0.3 30 1.5],...
    'HorizontalAlignment','left',...
    'FontWeight','bold','BackgroundColor',BkgColor);
ViewModeCmb = uicontrol(...
    'Style','Popupmenu','Tag','ViewModeCmb','Value',1,...
...
ViewPageCmb = uicontrol(...
    'Style','Popupmenu','Tag','ViewPageCmb','Value',1,...
...
uicontrol(...
    'Style','Edit','Tag','SliceXEdt','String',tmpstr,...
...
uicontrol(...
    'Style','Edit','Tag','SliceYEdt','String',tmpstr,...
...
uicontrol(...
    'Style','Edit','Tag','SliceZEdt','String',tmpstr,...
...
% Reverse Z axes %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Checkbox','Tag','ZReverseCheck',...
    'String','Z-Reverse','Value',ANAP.mview.zreverse,...
    'TooltipString','Zdir reverse',...
    'Parent',hMain,'Units','char','Position',[XDSP+78 H 20 1.5],...
...
uicontrol(...
    'Style','Text','String','AnaScale: ',...
    'Parent',hMain,'Units','char','Position',[XDSP+95 H-0.3 50 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',get(hMain,'color'));
uicontrol(...
    'Style','Edit','Tag','AnaScaleEdt','String',anascale,...
...
uicontrol(...
    'Style','Edit','Tag','AnaScaleEpiEdt','String',anascale,...
    'TooltipString','set anatomy scaling, [min max gamma]',...
    'Parent',hMain,'Units','char','Position',[XDSP+107 H 20.2 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''update-anascale'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','bold','visible','off');
clear anascale;



uicontrol(...
    'Style','Checkbox','Tag','EpiAnaCheck','String','EPI-ana','Value',0,...
    'TooltipString','use mean EPI as anatomy',...
    'Parent',hMain,'Units','char','Position',[XDSP+130 H 20 1.5],...
...
% SCALE BAR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Popupmenu','Tag','ScaleBarCmb',...
    'String',{'--- Scale Bar ---','2mm','4mm','5mm','10mm'},'Value',1,...
...
% SAVE MASK BUTTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','PushButton','Tag','SaveMaskBtn','String','Save as Mask',...
    'TooltipString','Save the current data as mask',...
    'Parent',hMain,'Units','char','Position',[XDSP+130 H-2 42 1.5],...
...
XDSP = 7;
axes(...
    'Tag','LightboxAxs','Box','off','color','black','Visible','off',...
    'Parent',hMain,'Units','char','Position',[XDSP H XSZ*2+10 YSZ*2+6.5]);
...
XDSP = 7;
uicontrol(...
    'Style','Text','Tag','CoronalTxt','String','Coronal (X-Z)',...
    'Parent',hMain,'Units','char','Position',[XDSP H+YSZ 20 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','CoronalEdt','String','',...
    'TooltipString','set coronal slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+22 H+YSZ+0.2 8 1.5],...
    'Callback','mview(''OrthoView_Callback'',gcbo,''edit-coronal'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','Bold');
uicontrol(...
    'Style','slider','Tag','CoronalSldr','SliderStep',[1 4],...
    'TooltipString','coronal slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+XSZ*0.6 H+YSZ+0.2 XSZ*0.4 1.2],...
    'Callback','mview(''Main_Callback'',gcbo,''update-hold'',guidata(gcbo))');
axes(...
    'Tag','CoronalAxs','Box','off','Color','black',...
    'Parent',hMain,'Units','char','Position',[XDSP H XSZ YSZ]);
uicontrol(...
    'Style','Text','Tag','SagitalTxt','String','Sagital (Y-Z)',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ H+YSZ 20 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','SagitalEdt','String','',...
    'TooltipString','set sagital slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+22 H+YSZ+0.2 8 1.5],...
    'Callback','mview(''OrthoView_Callback'',gcbo,''edit-sagital'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','Bold');
uicontrol(...
    'Style','slider','Tag','SagitalSldr','SliderStep',[1 4],...
    'TooltipString','sagital slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ*1.6 H+YSZ+0.2 XSZ*0.4 1.2],...
    'Callback','mview(''Main_Callback'',gcbo,''update-hold'',guidata(gcbo))');
SagitalAxs = axes(...
    'Tag','SagitalAxs','Box','off','Color','black',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ H XSZ YSZ]);

% CHECK BOX FOR "cross-hair" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Checkbox','Tag','CrosshairCheck',...
    'String','Crosshair','Value',1,...
    'TooltipString','show a crosshair',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+XSZ-15 H-3 20 1.5],...
...
H = 3;
uicontrol(...
    'Style','Text','Tag','TransverseTxt','String','Transverse (X-Y)',...
    'Parent',hMain,'Units','char','Position',[XDSP H+YSZ 20 1.5],...
    'FontWeight','bold','HorizontalAlignment','left',...
    'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','TransverseEdt','String','',...
    'TooltipString','set transverse slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+22 H+YSZ+0.2 8 1.5],...
    'Callback','mview(''OrthoView_Callback'',gcbo,''edit-transverse'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','Bold');
uicontrol(...
    'Style','slider','Tag','TransverseSldr','SliderStep',[1 4],...
    'TooltipString','transverse slice',...
    'Parent',hMain,'Units','char','Position',[XDSP+XSZ*0.6 H+YSZ+0.2 XSZ*0.4 1.2],...
    'Callback','mview(''Main_Callback'',gcbo,''update-hold'',guidata(gcbo))');
axes(...
    'Tag','TransverseAxs','Box','off','Color','black',...
    'Parent',hMain,'Units','char','Position',[XDSP H XSZ YSZ]);
...
%     'BackgroundColor',BkgColor);
uicontrol(...
    'Style','Popupmenu','Tag','TimeCourseCmb','Value',1,...
    'String',{'Voxel Time Course','Distribution (mean)','Distribution (max)'},...
    'TooltipString','Select statistics to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ H+YSZ+0.2 30 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''redraw-timecourse'',guidata(gcbo))',...
    'HorizontalAlignment','left','FontWeight','Bold');
axes(...
    'Tag','TimeCourseAxs','Box','off','color','white',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ H TCXSZ YSZ]);
uicontrol(...
    'Style','Checkbox','Tag','TCHoldCheck','String','Hold On','Value',0,...
    'TooltipString','hold on/off',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+TCXSZ-12 H+YSZ 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''update-hold'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Checkbox','Tag','BaseAlignCheck','String','base-align','Value',0,...
    'TooltipString','align baseline',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+TCXSZ-32 H+YSZ 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''redraw-timecourse'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Checkbox','Tag','ErrorbarCheck',...
    'String','Errorbar','Value',ANAP.mview.errorbar,...
    'TooltipString','show error-bar',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+TCXSZ-32 H+YSZ+1.5 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''redraw-timecourse'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Checkbox','Tag','TZeroCheck',...
    'String','T(1) as 0','Value',ANAP.mview.tzero,...
    'TooltipString','t(1) as 0',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+TCXSZ-12 H+YSZ+1.5 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''redraw-timecourse'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Checkbox','Tag','TStimCheck',...
    'String','Stim as 0','Value',ANAP.mview.tzero,...
    'TooltipString','stim as 0',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+TCXSZ-12 H+YSZ+3.0 20 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''redraw-timecourse'',guidata(gcbo))',...
    'FontWeight','bold','BackgroundColor',BkgColor);
...
XDSP=XDSP+XSZ+7;
axes(...
    'Tag','ColorbarAxs','Box','off','FontSize',8,...
    'YAxisLocation','left','XTickLabel',{},'XTick',[],...
    'Parent',hMain,'units','char','Position',[XDSP+10+XSZ+2 H XSZ*0.1 YSZ]);

% DATA FOR COLOR BAR %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Popupmenu','Tag','DataCmb','String',{'Response'},'Value',1,...
    'TooltipString','Select data to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15 H+YSZ-1.5 30 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''select-stat'',guidata(gcbo))',...
    'FontWeight','bold');

uicontrol(...
    'Style','Popupmenu','Tag','SelectValueCmb',...
    'String',{'positive','negative','pos+neg'},'Value',1,...
    'TooltipString','Select value to plot',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15 H+YSZ-3.5 30 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''select-stat'',guidata(gcbo))',...
    'FontWeight','bold');
...
% COLORBAR MIN-MAX %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Text','Tag','ColorbarMinMaxTxt','String','min-max: ',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15, H+YSZ-5.5 20 1.25],...
    'FontWeight','bold','HorizontalAlignment','left','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','ColorbarMinMaxEdt','String','',...
    'TooltipString','set colorbar min max',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+27, H+YSZ-5.5 18 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''update-cmap-redraw'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','Bold');

% COLORBAR GAMAMA SETTING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Text','Tag','GammaTxt','String','gamma: ',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15, H+YSZ-7.5 20 1.25],...
    'FontWeight','bold','HorizontalAlignment','left','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Edit','Tag','GammaEdt','String',num2str(ANAP.mview.gamma),...
    'TooltipString','set a gamma value for color bar',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+27, H+YSZ-7.5 18 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''update-cmap-redraw'',guidata(gcbo))',...
    'HorizontalAlignment','center','FontWeight','bold');

% COLOR-MAP SETTING %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cmaps = {'AUTO','mri','autumn','winter','spring','summer','hot','cool','parula','jet','hsv','bone','copper','pink','red256','green256','blue256','yellow256','cyan256','magenta256'};
if verLessThan('matlab','8.4')
  % for R2014a and earlier ones.
  cmaps = cmaps(~strcmpi(cmaps,'parula'));  % remove 'parula' which is supported from R2014b.
end
...
uicontrol(...
    'Style','Text','Tag','ColormapTxt','String','colormap: ',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15, H+YSZ-9.5 20 1.25],...
    'FontWeight','bold','HorizontalAlignment','left','BackgroundColor',BkgColor);
uicontrol(...
    'Style','Popupmenu','Tag','ColormapCmb','String',cmaps,'Value',idx,...
    'TooltipString','Select colormap',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+27 H+YSZ-9.5 18 1.5],...
    'Callback','mview(''Main_Callback'',gcbo,''update-cmap-redraw'',guidata(gcbo))',...
    'FontWeight','bold');
clear cmaps idx;
% Superimpose or not %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
uicontrol(...
    'Style','Checkbox','Tag','OverlayCheck','String','StatMap Overlay','Value',1,...
    'TooltipString','map on/off',...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15 H+YSZ-11.5 25 1.5],...
...
H = 27.5;
uicontrol(...
    'Style','Listbox','Tag','InfoTxt',...
    'String',{'session','group','datsize','resolution'},...
    'Parent',hMain,'Units','char','Position',[XDSP+10+XSZ+15 H 30 8],...
...
switch lower(eventdata)
 ...
 case {'init-stat'}
  ...
  if isfield(ANAP.mview,'datname')
    switch lower(ANAP.mview.datname),
  ...
  switch lower(StatName)
   case {'corr'}
    models = cell(1,length(ROITS{1}{1}.r));
    for N = 1:length(ROITS{1}{1}.r)
      if isfield(grp,'corana') && length(grp.corana) == length(ROITS{1}{1}.r)
        models{N} = sprintf('%d: %s',N,grp.corana{N}.mdlsct);
      else
        models{N} = sprintf('%d',N);
      end
    end
   ...
   case {'glm'}
    models = cell(1,length(ROITS{1}{1}.glmcont));
    for N = 1:length(ROITS{1}{1}.glmcont)
      models{N} = sprintf('%d: %s',N,ROITS{1}{1}.glmcont(N).cont.name);
    end
 ...
 case {'append','replace'}
  ...
  while 1
    ...
    if length(anax) > 2
      ...
      % put some text
      if K == 1
        text(max(get(gca,'xlim'))-1.5,max(get(gca,'ylim'))-1.5,'PickArea:ON','tag','PickArea',...
...
switch lower(eventdata)
 ...
 case {'redraw'}
  ...
  X = (0:size(ANA.dat,Xdim)-1)/ANA.episcale(Xdim) + 0.5 + 0.5/ANA.episcale(Xdim);
  Y = (0:size(ANA.dat,Ydim)-1)/ANA.episcale(Ydim) + 0.5 + 0.5/ANA.episcale(Ydim);
  ...
  if ~isempty(STATMAP) && get(wgts.OverlayCheck,'Value')
    if ~strcmpi(TrialNo,'all')
      % show signif. voxels of the selected trial
      STAT_OVERLAY_MODE = 1;
    else
      % plot signif. voxels of all trials
      STAT_OVERLAY_MODE = 2;
    end
  else
    STAT_OVERLAY_MODE = 0;
  ...
  delete(findobj(wgts.LightboxAxs,'tag','imgmap'));
  delete(findobj(wgts.LightboxAxs,'tag','signif.voxel'));
  delete(findobj(wgts.LightboxAxs,'tag','textstr'));
  delete(findobj(wgts.LightboxAxs,'tag','PickArea'));
  set(wgts.main,'CurrentAxes',wgts.LightboxAxs);
  % cla;
  ...
  for N = 1:length(SLICES)
    ...
    if STAT_OVERLAY_MODE > 0
      ...
      tmpstr2 = sprintf('%s ROI=%s P<%s Model=%s/%s',tmpstr2,RoiName,...
                        get(wgts.AlphaEdt,'String'),StatName,ModelNo);
    ...
    image(tmpx,tmpy,tmpimg,'tag','imgmap');  hold on;
     
    
    if STAT_OVERLAY_MODE == 2
      % plot all trials
      for T = 1:length(STATMAP)
        if iDimension == 1
          tmpp = squeeze(STATMAP{T}.p(iSlice,:,:));
        ...
        if ~isempty(idx)
          ...
          tmpx2 = tmpx2 + offsX;  tmpy2 =  tmpy2 + offsY;
          tmpcol = MAPCOLOR(mod(T-1,length(MAPCOLOR))+1);
          if iscell(tmpcol)
            tmpcol = tmpcol{1} ;
          end
    ...
    text(offsX+1,offsY+1,sprintf('%s=%d',INFSTR,iSlice),...
         'color',[0.9 0.9 0.5],'VerticalAlignment','top','tag','textstr',...
         'FontName','Comic Sans MS','FontSize',8,'Fontweight','bold');

    if iDimension == 3
      %set(gca,'drawmode','fast');
      if 1 || get(wgts.DrawRoiCheck,'value') > 0
        subDrawROIs(wgts.LightboxAxs,ROI,iSlice,RoiName,COLORS,offsX,...
                    offsY,0,get(wgts.DrawRoiCheck,'Value'))
      end
      if 1 || get(wgts.DrawEleCheck,'value') > 0
        subDrawELEs(wgts.LightboxAxs,ROI,iSlice,RoiName,COLORS,offsX,...
                    offsY,0,get(wgts.DrawEleCheck,'Value')) ;
      end
    end
  ...
  for K = 1:length(PICKAREA)
    if PICKAREA{K}.ipage == ipage
      plot(PICKAREA{K}.px,PICKAREA{K}.py,'color',[0 1.0 0],'tag','PickArea');
    end
    if K == 1
      text(nX*NCol-1,nY*NRow-1,'PickArea:ON','tag','PickArea',...
           'color',[0.9 0.9 0.5],'VerticalAlignment','bottom',...
           'HorizontalAlignment','right','tag','textstr',...
           'FontName','Comic Sans MS','FontSize',8,'Fontweight','bold');
    end
  end
  % X(1:5)
  ...
  set(haxs,'Tag','LightboxAxs','color','black',...
           ...
           'xlim',[0.5 nX*NCol+0.5],'ylim',[0.5 nY*NRow+0.5],...
           'YDir','reverse');
  %set(get(haxs,'Children'),...
  set(findobj(haxs,'tag','imgmap'),...
 ...
 case {'update-scalebar'}
  ...
  if ~isempty(ScaleBar) && ScaleBar > 0
    ...
    tmpx = round(max(xlm))-MARGIN;      tmpy = round(max(ylm)) - MARGIN;
    tmpw = ScaleBar/DXmm;  tmph = ScaleBar*0.15/DYmm;
    rectangle('Position',[tmpx-tmpw tmpy-tmph tmpw tmph],...
              'facecolor',[1.0 1.0 1.0],'linestyle','none','Tag','ScaleBar');
    text(tmpx-tmpw, tmpy, sprintf('%dmm ',ScaleBar),'tag','ScaleBarTxt',...
         'color',[0.9 0.9 0.5],'HorizontalAlignment','right','VerticalAlignment','bottom',...
         'FontName','Comic Sans MS','FontSize',8,'Fontweight','bold');
...
if any(imsz ~= size(STATV))
  ...
  %   STATV = imresize_old(STATV,imsz,METHOD,0);
  %   PVAL  = imresize_old(PVAL, imsz,METHOD,0);
  % else
    STATV = imresize(STATV,imsz,METHOD);
    PVAL  = imresize(PVAL, imsz,METHOD);
  % end
end
...
if get(wgts.TCHoldCheck,'Value') && get(wgts.ColormapCmb,'Value') == 1
  ...
  switch lower(CMAPSTR)
   case {'mri'}
    ...
    CMAP = [negmap; posmap];
   case {'autumn','winter','spring','summer','hot','cool','parula','jet','hsv','bone','copper','pink'}
...
if get(wgts.TCHoldCheck,'Value') == 0
  % cla;
  delete(allchild(wgts.TimeCourseAxs));
  delete(findobj(wgts.main,'Tag','TC-legend'));
  set(haxs,'UserData',[]);
end
...
for iTrial = 1:length(TrialNo)
  ...
  if ~isempty(PICKAREA)
    ...
    [idx, found] = intersect(TCTRIAL{T}.sub2ind,idx);
    tmpsel{1} = found;
    tmptxt{1} = sprintf('%s N=%d',RoiName,length(idx));
  else
...
if get(wgts.TCHoldCheck,'Value') == 0
  ...
  if length(tmpsel) == 1
    tmpstr = sprintf('Nvox=%d ROI=%s',...
                     size(tcdat,2),RoiName);
  else
    tmpstr = sprintf('Nvox=%d/%d ROI=%s',...
                     length(tmpsel{1}),length(tmpsel{2}),RoiName);
  end
  if strcmpi(RoiName,'PickArea')
  elseif strcmpi(StatName,'none')
    tmpstr = sprintf('%s Model=%s',...
                     tmpstr,StatName);
  else
    tmpstr = sprintf('%s P<%s %s/%s',...
                     tmpstr,get(wgts.AlphaEdt,'String'),StatName,ModelNo);
  end
  text(0.01,0.99,strrep(tmpstr,'_','\_'),'units','normalized',...
       'FontName','Comic Sans MS','tag','Nvox',...
       'HorizontalAlignment','left','VerticalAlignment','top');
  if get(wgts.ErrorbarCheck,'value') > 0
    text(0.99,0.01,'mean+-sem','units','normalized',...
         'FontName','Comic Sans MS','tag','Info',...
         'HorizontalAlignment','right','VerticalAlignment','bottom');
  else
    text(0.99,0.01,'mean','units','normalized',...
         'FontName','Comic Sans MS','tag','Info',...
         'HorizontalAlignment','right','VerticalAlignment','bottom');
  end
  set(haxs,'layer','top');
  ...
  legend(haxs,legtxt,'Tag','TC-legend');
...
nx = EPIDIM(1); ny = EPIDIM(2);

if isempty(anamask) || size(anamask,1) ~= NCol*nx || size(anamask,2) ~= NRow*ny
...
%fprintf('size(anamask)=[%s]\n',deblank(sprintf('%d ',size(anamask))));

epimask = imresize(anamask,[EPIDIM(1)*NCol, EPIDIM(2)*NRow]);


[maskX, maskY] = find(epimask > 0);
epix = zeros(size(maskX));
epiy = zeros(size(maskY));
epiz = zeros(size(maskX));
for N=1:length(maskX)
  iCol = min(NCol,max(1,floor((maskX(N)-0.5)/nx)+1));
  iRow = min(NRow,max(1,floor((maskY(N)-0.5)/ny)+1));
  tmpi = (iRow-1)*NCol + iCol;
  if tmpi > 0 && tmpi <= length(SLICES)
    epix(N) = maskX(N) - (iCol-1)*nx;
    epiy(N) = maskY(N) - (iRow-1)*ny;
    epiz(N) = SLICES((iRow-1)*NCol + iCol);
  end
end
...
ROI.name = 'PickArea';
ROI.epiidx = unique(sub2ind(EPIDIM,epix,epiy,epiz)); % epix as y of original data
ROI.px     = anapx;
ROI.py     = anapy;
ROI.ipage  = ipage;
