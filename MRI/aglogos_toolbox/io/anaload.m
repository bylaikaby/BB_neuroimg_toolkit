function ANA = anaload(Ses,ExpNo,USE_EPI,GetRGB,varargin)
...
%  ANA = ANALOAD(SES,Grp/Exp,USE_EPI=0|1,GetRGB=0|1,...) reads the structual images or EPI as
%  anatomy.  If GetRGB==1, then adds .rgb as grayscale images of the anatomy.
%
%  Supported options are:
%    AnaGamma  : Gamma correction for gray scale anatomy
...
%           dx: 2
%          dat: [140x80x2 double]
%          rgb: [140x80x2x4 double]  <-- RGB if GetRGB==1
%        scale: [1000 25000 1.5]     <-- scaling for RGB as [min max gamma]
%
%  NOTE :
...
%    0.98 26.07.17 YM   support options, 'AnaGamma' and 'AnaScale'.
%
