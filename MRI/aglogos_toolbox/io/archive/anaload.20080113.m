function ANA = anaload(Ses,ExpNo,ImgDistort,GetRGB)
...
if ImgDistort > 0,
  ...
  elseif exist(catfilename(Ses,grp.exps(1),'mat'),'file') & ~isempty(who('-file',catfilename(Ses,grp.exps(1),'mat'),'roiTs')),
