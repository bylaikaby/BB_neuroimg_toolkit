...
% img = read2dseq('rathead16T.raw',256,1,256,140,1,140,256,1,256,1,1,'littleEndian','_16BIT_SGN_INT','double');
img = read2dseq(tcImg.dir.imgfile,nx,x1,x2,ny,y1,y2,ns,ns1,ns2,t1,t2,...
                pvpar.reco.RECO_byte_order,pvpar.reco.RECO_wordtype,IDATCLASS);
...
if ISAVE,
  try
    if SAVEAS_IMG,
      ...
      if ~exist(fileparts(tcImg.dir.datfile),'dir'),
    ...
    %end
    bakfile = sprintf('%s.bak',tcImg.dir.tcimgfile);
