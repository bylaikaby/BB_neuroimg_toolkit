...
%   1.14 12.05.14 YM  use pvread_2dseq() instead of read2dseq().
%
...
fprintf(' read.');
img = pvread_2dseq(tcImg.dir.imgfile,...
                   'WordType',pvpar.reco.RECO_wordtype,...
                   'ByteOrder',pvpar.reco.RECO_byte_order,...
                   'ImgCrop',EXPP.imgcrop,...
                   'SliCrop',slicrop,'TimeCrop',[]);
