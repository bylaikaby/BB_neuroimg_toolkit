...
blackCenter = r > halfSize(1);
blackCenter2= r < fixSize;

clear x y r ringFunction wedgeMask ringMask theta

temp = white*ones(stimSize); temp(find(checkerboard)) = backgroundColor; temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
stim(:,:,1) = temp;
temp = black*ones(stimSize); temp(find(checkerboard)) = backgroundColor; temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
stim(:,:,2) = temp;
temp = white*ones(stimSize); temp(find(checkerboard)) = backgroundColor; temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
stim(:,:,3) = temp;
temp = black*ones(stimSize); temp(find(checkerboard)) = backgroundColor;  temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
...
temp = mixed*ones(stimSize); temp(find(checkerboard)) = backgroundColor; temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
stim(:,:,5) = temp;
temp = mixed*ones(stimSize); temp(find(checkerboard)) = backgroundColor;  temp(find(blackCenter)) = backgroundColor; temp(find(blackCenter2)) = backgroundColor; 
stim(:,:,6) = temp;
